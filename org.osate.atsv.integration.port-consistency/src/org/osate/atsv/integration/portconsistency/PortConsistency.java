 ...
 * DM17-0002
 *******************************************************************************/
package org.osate.atsv.integration.portconsistency;
...
public class PortConsistency extends AbstractAnalysis {
	...
	public void runAnalysis(SystemInstance instance, SystemOperationMode som, AnalysisErrorReporterManager errMgr,
		...
		this.resp = resp;
		MyPortConnectionConsistency ppc = new MyPortConnectionConsistency(null, null);
		ppc.initSwitches();
		ppc.defaultTraversal(instance);
	}
