	...
	public static final class NameMappings {
		...
		private static final class Init0 {
			private static void doInit(ImmutableMap.Builder<AbstractElement, String> builder, ConfigGrammarAccess grammarAccess) {
				...
				builder.put(grammarAccess.getConfigParameterAccess().getAlternatives_2(), "rule__ConfigParameter__Alternatives_2");
				builder.put(grammarAccess.getCandidateValueAccess().getAlternatives(), "rule__CandidateValue__Alternatives");
				...
				builder.put(grammarAccess.getConfigElementAccess().getAlternatives(), "rule__ConfigElement__Alternatives");
				...
				builder.put(grammarAccess.getConfigPkgAccess().getGroup(), "rule__ConfigPkg__Group__0");
				...
				builder.put(grammarAccess.getAnalysesAccess().getGroup_3(), "rule__Analyses__Group_3__0");
				builder.put(grammarAccess.getOutputsAccess().getGroup(), "rule__Outputs__Group__0");
				builder.put(grammarAccess.getOutputsAccess().getGroup_3(), "rule__Outputs__Group_3__0");
				builder.put(grammarAccess.getOutputVariableAccess().getGroup(), "rule__OutputVariable__Group__0");
				builder.put(grammarAccess.getOutputVariableAccess().getGroup_1(), "rule__OutputVariable__Group_1__0");
				...
				builder.put(grammarAccess.getWithAccess().getGroup_2(), "rule__With__Group_2__0");
				...
				builder.put(grammarAccess.getConfigParameterAccess().getGroup(), "rule__ConfigParameter__Group__0");
				builder.put(grammarAccess.getFClassifierTypeAccess().getGroup(), "rule__FClassifierType__Group__0");
				builder.put(grammarAccess.getCandidatesAccess().getGroup(), "rule__Candidates__Group__0");
				builder.put(grammarAccess.getCandidatesAccess().getGroup_3(), "rule__Candidates__Group_3__0");
				builder.put(grammarAccess.getCandidatesAccess().getGroup_3_1(), "rule__Candidates__Group_3_1__0");
				builder.put(grammarAccess.getCandidateValueAccess().getGroup_0(), "rule__CandidateValue__Group_0__0");
				builder.put(grammarAccess.getCandidateValueAccess().getGroup_1(), "rule__CandidateValue__Group_1__0");
				...
				builder.put(grammarAccess.getAssignmentsAccess().getGroup_1_1(), "rule__Assignments__Group_1_1__0");
				builder.put(grammarAccess.getAssignmentsAccess().getGroup_3(), "rule__Assignments__Group_3__0");
				builder.put(grammarAccess.getAssignmentsAccess().getGroup_3_2(), "rule__Assignments__Group_3_2__0");
				builder.put(grammarAccess.getAssignmentsAccess().getGroup_3_2_1(), "rule__Assignments__Group_3_2_1__0");
				builder.put(grammarAccess.getAssignmentAccess().getGroup(), "rule__Assignment__Group__0");
				builder.put(grammarAccess.getAssignmentAccess().getGroup_0_0(), "rule__Assignment__Group_0_0__0");
				builder.put(grammarAccess.getAssignmentAccess().getGroup_0_0_1(), "rule__Assignment__Group_0_0_1__0");
				builder.put(grammarAccess.getAssignmentAccess().getGroup_0_1(), "rule__Assignment__Group_0_1__0");
				builder.put(grammarAccess.getConfigValueAccess().getGroup_0(), "rule__ConfigValue__Group_0__0");
				builder.put(grammarAccess.getConfigValueAccess().getGroup_1(), "rule__ConfigValue__Group_1__0");
				builder.put(grammarAccess.getConfigValueAccess().getGroup_2(), "rule__ConfigValue__Group_2__0");
				...
				builder.put(grammarAccess.getConditionValueAccess().getGroup_0(), "rule__ConditionValue__Group_0__0");
				builder.put(grammarAccess.getConditionValueAccess().getGroup_1(), "rule__ConditionValue__Group_1__0");
				builder.put(grammarAccess.getConfigElementAccess().getGroup_0(), "rule__ConfigElement__Group_0__0");
				builder.put(grammarAccess.getConfigElementAccess().getGroup_0_1(), "rule__ConfigElement__Group_0_1__0");
				builder.put(grammarAccess.getConfigElementAccess().getGroup_1(), "rule__ConfigElement__Group_1__0");
				builder.put(grammarAccess.getCNAMEAccess().getGroup(), "rule__CNAME__Group__0");
				builder.put(grammarAccess.getCNAMEAccess().getGroup_1(), "rule__CNAME__Group_1__0");
				builder.put(grammarAccess.getCNAMEAccess().getGroup_2(), "rule__CNAME__Group_2__0");
				...
				builder.put(grammarAccess.getConfigPkgAccess().getConfigurationsAssignment_2(), "rule__ConfigPkg__ConfigurationsAssignment_2");
				builder.put(grammarAccess.getRootAccess().getRootAssignment_1(), "rule__Root__RootAssignment_1");
				builder.put(grammarAccess.getAnalysesAccess().getAnalysesAssignment_2(), "rule__Analyses__AnalysesAssignment_2");
				builder.put(grammarAccess.getAnalysesAccess().getAnalysesAssignment_3_1(), "rule__Analyses__AnalysesAssignment_3_1");
				builder.put(grammarAccess.getOutputsAccess().getOutputsAssignment_2(), "rule__Outputs__OutputsAssignment_2");
				builder.put(grammarAccess.getOutputsAccess().getOutputsAssignment_3_1(), "rule__Outputs__OutputsAssignment_3_1");
				builder.put(grammarAccess.getOutputVariableAccess().getNameAssignment_0(), "rule__OutputVariable__NameAssignment_0");
				builder.put(grammarAccess.getOutputVariableAccess().getTypeAssignment_1_1(), "rule__OutputVariable__TypeAssignment_1_1");
				builder.put(grammarAccess.getOutputVariableAccess().getLimitAssignment_2(), "rule__OutputVariable__LimitAssignment_2");
				builder.put(grammarAccess.getLimitAccess().getRelationAssignment_0(), "rule__Limit__RelationAssignment_0");
				builder.put(grammarAccess.getLimitAccess().getBoundAssignment_1(), "rule__Limit__BoundAssignment_1");
				builder.put(grammarAccess.getConfigurationAccess().getNameAssignment_1(), "rule__Configuration__NameAssignment_1");
				builder.put(grammarAccess.getConfigurationAccess().getExtendedAssignment_3_1(), "rule__Configuration__ExtendedAssignment_3_1");
				builder.put(grammarAccess.getWithAccess().getCombinedAssignment_1(), "rule__With__CombinedAssignment_1");
				builder.put(grammarAccess.getWithAccess().getCombinedAssignment_2_1(), "rule__With__CombinedAssignment_2_1");
				builder.put(grammarAccess.getCombinationAccess().getUnsafeAssignment_0(), "rule__Combination__UnsafeAssignment_0");
				builder.put(grammarAccess.getCombinationAccess().getConfigurationAssignment_1(), "rule__Combination__ConfigurationAssignment_1");
				...
				builder.put(grammarAccess.getConfigParameterAccess().getNameAssignment_0(), "rule__ConfigParameter__NameAssignment_0");
				builder.put(grammarAccess.getConfigParameterAccess().getChoicesAssignment_3(), "rule__ConfigParameter__ChoicesAssignment_3");
				builder.put(grammarAccess.getFClassifierTypeAccess().getCategoryAssignment_0(), "rule__FClassifierType__CategoryAssignment_0");
				builder.put(grammarAccess.getFClassifierTypeAccess().getClassifierAssignment_1(), "rule__FClassifierType__ClassifierAssignment_1");
				builder.put(grammarAccess.getFPropertyTypeAccess().getPropertyTypeAssignment(), "rule__FPropertyType__PropertyTypeAssignment");
				builder.put(grammarAccess.getCandidatesAccess().getCandidatesAssignment_3_0(), "rule__Candidates__CandidatesAssignment_3_0");
				builder.put(grammarAccess.getCandidatesAccess().getCandidatesAssignment_3_1_1(), "rule__Candidates__CandidatesAssignment_3_1_1");
				builder.put(grammarAccess.getCandidateValueAccess().getRefAssignment_0_1(), "rule__CandidateValue__RefAssignment_0_1");
				builder.put(grammarAccess.getCandidateValueAccess().getExpAssignment_1_1(), "rule__CandidateValue__ExpAssignment_1_1");
				builder.put(grammarAccess.getAssignmentsAccess().getAssignmentsAssignment_1_0(), "rule__Assignments__AssignmentsAssignment_1_0");
				builder.put(grammarAccess.getAssignmentsAccess().getAssignmentsAssignment_1_1_1(), "rule__Assignments__AssignmentsAssignment_1_1_1");
				builder.put(grammarAccess.getAssignmentsAccess().getConstraintsAssignment_3_2_0(), "rule__Assignments__ConstraintsAssignment_3_2_0");
				builder.put(grammarAccess.getAssignmentsAccess().getConstraintsAssignment_3_2_1_1(), "rule__Assignments__ConstraintsAssignment_3_2_1_1");
				builder.put(grammarAccess.getAssignmentAccess().getWildcardAssignment_0_0_0_0(), "rule__Assignment__WildcardAssignment_0_0_0_0");
				builder.put(grammarAccess.getAssignmentAccess().getRefAssignment_0_0_0_1(), "rule__Assignment__RefAssignment_0_0_0_1");
				builder.put(grammarAccess.getAssignmentAccess().getPropertyAssignment_0_0_1_1(), "rule__Assignment__PropertyAssignment_0_0_1_1");
				builder.put(grammarAccess.getAssignmentAccess().getPropertyAssignment_0_1_1(), "rule__Assignment__PropertyAssignment_0_1_1");
				builder.put(grammarAccess.getAssignmentAccess().getValueAssignment_2(), "rule__Assignment__ValueAssignment_2");
				builder.put(grammarAccess.getConfigValueAccess().getRefAssignment_0_1(), "rule__ConfigValue__RefAssignment_0_1");
				builder.put(grammarAccess.getConfigValueAccess().getExpAssignment_1_1(), "rule__ConfigValue__ExpAssignment_1_1");
				builder.put(grammarAccess.getArgumentsAccess().getArgumentsAssignment_1_0(), "rule__Arguments__ArgumentsAssignment_1_0");
				...
				builder.put(grammarAccess.getConstraintAccess().getRelationAssignment_1_0(), "rule__Constraint__RelationAssignment_1_0");
				builder.put(grammarAccess.getConstraintAccess().getConsequenceAssignment_1_1(), "rule__Constraint__ConsequenceAssignment_1_1");
				builder.put(grammarAccess.getConditionAccess().getLhsAssignment_0(), "rule__Condition__LhsAssignment_0");
				builder.put(grammarAccess.getConditionAccess().getRelationAssignment_1(), "rule__Condition__RelationAssignment_1");
				builder.put(grammarAccess.getConditionAccess().getRhsAssignment_2(), "rule__Condition__RhsAssignment_2");
				builder.put(grammarAccess.getSetValueAccess().getElementsAssignment_1(), "rule__SetValue__ElementsAssignment_1");
				builder.put(grammarAccess.getSetValueAccess().getElementsAssignment_2_1(), "rule__SetValue__ElementsAssignment_2_1");
				builder.put(grammarAccess.getConditionValueAccess().getRefAssignment_0_2(), "rule__ConditionValue__RefAssignment_0_2");
				builder.put(grammarAccess.getConditionValueAccess().getExpAssignment_1_1(), "rule__ConditionValue__ExpAssignment_1_1");
				builder.put(grammarAccess.getConfigElementAccess().getElementAssignment_0_0(), "rule__ConfigElement__ElementAssignment_0_0");
				builder.put(grammarAccess.getConfigElementAccess().getPropertyAssignment_0_1_1(), "rule__ConfigElement__PropertyAssignment_0_1_1");
				builder.put(grammarAccess.getConfigElementAccess().getPropertyAssignment_1_1(), "rule__ConfigElement__PropertyAssignment_1_1");
		...
		@Inject
		public NameMappings(ConfigGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ConfigGrammarAccess grammarAccess) {
