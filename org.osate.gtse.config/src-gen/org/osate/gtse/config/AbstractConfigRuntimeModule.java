...
import org.osate.gtse.config.parser.antlr.ConfigAntlrTokenFileProvider;
import org.osate.gtse.config.parser.antlr.ConfigParser;
import org.osate.gtse.config.parser.antlr.internal.InternalConfigLexer;
import org.osate.gtse.config.scoping.ConfigScopeProvider;
import org.osate.gtse.config.serializer.ConfigSemanticSequencer;
import org.osate.gtse.config.serializer.ConfigSyntacticSequencer;
...
public abstract class AbstractConfigRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/osate/gtse/config/Config.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.osate.gtse.config.Config");
	}
