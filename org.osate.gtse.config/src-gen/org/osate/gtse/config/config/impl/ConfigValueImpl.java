 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.gtse.config.config.impl.ConfigValueImpl#getAssignments <em>Assignments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigValueImpl extends MinimalEObjectImpl.Container implements ConfigValue
{
  ...
  {
    return ConfigPackage.Literals.CONFIG_VALUE;
  }
  ...
  public EList<Assignment> getAssignments()
  {
    if (assignments == null)
    {
      assignments = new EObjectContainmentEList<Assignment>(Assignment.class, this, ConfigPackage.CONFIG_VALUE__ASSIGNMENTS);
    }
    return assignments;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ConfigPackage.CONFIG_VALUE__ASSIGNMENTS:
