...
public interface PropertyValue extends ConfigValue, ConditionValue
{
   ...
   * @see #setExp(PropertyExpression)
   * @see org.osate.gtse.config.config.ConfigPackage#getPropertyValue_Exp()
   * @model containment="true"
   * @generated
   */
  PropertyExpression getExp();

  /**
   * Sets the value of the '{@link org.osate.gtse.config.config.PropertyValue#getExp <em>Exp</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
